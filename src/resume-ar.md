# معاذ جابر — مهندس برمجيات

**الهاتف:** +216 58 201 430  
**البريد الإلكتروني:** mouadh.jaber@msn.com  
...
- **الهندسة/المعمارية:** تطبيقات موزعة، مركبة، وذات زمن حقيقي؛ نماذج متعددة الطبقات؛ Microservices؛ Mesh؛ وبنية أحادية (Monolith).
- **المنهجيات:** XP، Scrum، SAFe، TDD، BDD.
- **العمليات:** ITIL، DevOps، DevSecOps.
- **النمذجة:** UML v2، Merise.
- **التواصل:** Web، Pipes، Sockets، Messaging، SOA، JSON.
...
- SharePoint / MOSS / Office 365
- Azure Service Bus و Azure Cloud

### الأدوات
Visual Studio (2008–2022)، TFS / Azure DevOps، TeamCity، CVS/SVN، Eclipse، MS Project / Project Server.

## الخبرات المهنية (الأحدث أولاً)

### NETCOM — الاتصالات (يوليو 2025 – حتى الآن)
**مهندس برمجيات أول**
- تطوير تطبيقات موبايل (Flutter)
- تطوير حول نظام CRM داخلي
...
**مهندس برمجيات أول**
- هندسة برمجيات تصفية/تسوية (Liquidation) في جانب البيع (Sell-side)  
**التقنيات:** C++، Delphi

### ASTERA — سلاسل الإمداد الدوائية (مايو 2023 – أكتوبر 2024) — روان، فرنسا
**مهندس برمجيات أول**
...
**مهندس / معماري أول**
- توفير بنى تحتية وخدمات IT Provisioning
